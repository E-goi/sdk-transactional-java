...
public class Error500 {
  ...
  public Error500 type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
   ...
   * @return title
  **/
  @Schema(example = "Internal Server Error", description = "The title of the error")
   ...
   * @return status
  **/
  @Schema(example = "500", description = "The code status of the error.")
  ...
  public Error500 detail(String detail) {
    this.detail = detail;
    return this;
  }
   ...
   * @return detail
  **/
  @Schema(example = "The server encountered an unexpected condition which prevented it from fulfilling the request. Retry again the request in a while.", description = "A message with a finer detail.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, error500.type) &&
        Objects.equals(this.title, error500.title) &&
        Objects.equals(this.status, error500.status) &&
        Objects.equals(this.detail, error500.detail);
  }
