...
/**
 * API tests for MultiChannelApi
 */
@Ignore
public class MultiChannelApiTest {

    private final MultiChannelApi api = new MultiChannelApi();
     ...
     */
    @Test
    public void createMultiChannelFlowTest() throws ApiException {
        MultiChannelFlowRequest body = null;
        MultiChannelFlowIdResponse response = api.createMultiChannelFlow(body);
     ...
     */
    @Test
    public void executeMultiChannelTest() throws ApiException {
        ExecuteMultiChannelRequest body = null;
        MultiChannelIdResponse response = api.executeMultiChannel(body);
     ...
     */
    @Test
    public void listMultiChannel2Test() throws ApiException {
        String id = null;
        List<MultiChannelFlowResponse> response = api.listMultiChannel2(id);
     ...
     */
    @Test
    public void listMultiChannelsTest() throws ApiException {
        List<MultiChannelFlowResponse> response = api.listMultiChannels();
     ...
     */
    @Test
    public void removeMultiChannelTest() throws ApiException {
        String id = null;
        api.removeMultiChannel(id);
