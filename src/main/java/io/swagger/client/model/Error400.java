...
public class Error400 {
  ...
  public Error400 type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
   ...
   * @return title
  **/
  @Schema(example = "Bad Request", description = "The title of the error")
   ...
   * @return status
  **/
  @Schema(example = "400", description = "The code status of the error.")
  ...
  public Error400 detail(String detail) {
    this.detail = detail;
    return this;
  }
   ...
   * @return detail
  **/
  @Schema(example = "The request could not be understood by the server due to malformed syntax. The client should revise the request and try again.", description = "A message with a finer detail.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, error400.type) &&
        ...
        Objects.equals(this.detail, error400.detail);
  }
