...
public class HtmlToPdfRequest {
   ...
   * @return html
  **/
  @Schema(example = "<html_here>", description = "Html String")
  ...
  public HtmlToPdfRequest url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return url
  **/
  @Schema(example = "your_url_here", description = "Url to the html file")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.html, htmlToPdfRequest.html) &&
        Objects.equals(this.url, htmlToPdfRequest.url);
  }
